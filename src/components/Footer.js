...
const Footer = ()=>{
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-10 md:gap-40 lg:gap-60  md:grid-cols-2 lg:grid-cols-2">
      <div class="">
        <h6
          class="mb-4 flex text-neutral-300 items-center justify-center font-semibold uppercase md:justify-start">
...
Puducherry Technological University <br/>- PUDUCHERRY, INDIA
        </h6>
      </div>
      
      <div>
        <p class="flex text-neutral-300 pl-12 items-center justify-center md:justify-start">
  ...
  <div className="bg-blue-900 p-4 text-center text-xl text-yellow-500">
