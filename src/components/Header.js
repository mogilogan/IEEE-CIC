...
COMPUTATIONAL INTELLIGENCE AND COMMUNICATION</span>
            ...
            <h1 className='py-4 text-center text-lg md:text-2xl sm:font-bold leading-none tracking-normal md:tracking-tight'><span className="block w-full pb-4 text-transparent bg-clip-text text-[10px] sm:text-lg md:text-3xl text-yellow-500 leading-12  lg:inline  ">IEEE ICACIC 2023<br/>7<sup>th </sup> & 8<sup>th</sup> December 2023</span><span className='hidden  text-blue-800 text-lg md:text-2xl lg:pt-4 sm:block'>
