...
Puducherry Technological University, Puducherry, 605014, India</span></span></h1>
    ...
    <div class="flex justify-center items-baseline flex-wrap">
        ...
        <div class="flex m-2">
           <a href="/"><button class="text-base  rounded-r-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        ...
        border-teal-600 transition">
            ...
            <a href="/call"><button class="text-base  rounded-l-none rounded-r-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
        border-teal-600 transition">
          ...
          <a href="/paper">  <button class="text-base  rounded-l-none rounded-r-none   hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
        border-teal-600 transition">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"  width="21" viewBox="0 0 24 24" fill="none"><path fill="currentColor" d="M6 21h12c-1 0-3-.6-3-3v-2H3v2c0 2.4 2 3 3 3z"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v13c0 1-.6 3-3 3m0 0H6c-1 0-3-.6-3-3v-2h12v2c0 2.4 2 3 3 3zM9 7h8m-8 4h4"/></svg>
                    PAPER SUBMISSIONS</div>
            </button></a> 
           <a href="/registrations"> <button class="text-base  rounded-l-none rounded-r-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
        border-teal-600 transition">
           ...
           <a href="/venue"> <button class="text-base rounded-l-none   rounded-r-none   hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
        border-teal-600 transition">
            ...
            <a href="/committees"><button class="text-base  rounded-l-none rounded-r-none   hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
        border-teal-600 transition">
            ...
            <a href="/timelines"><button class="text-base  rounded-l-none rounded-r-none   hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer 
        hover:bg-teal-700 hover:text-teal-100 
        bg-teal-100 
        text-teal-700 
        border duration-200 ease-in-out 
...
<div class="lg:hidden" id="mobile-menu">
    <div class="space-y-1 px-2 pt-2 pb-3">
      ...
      <a href='/' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"><button type="button" >
    HOME
  </button></a>
  <a href='/call' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"> <button type="button" >
    CALL FOR PAPERS
  </button></a>
  <a href='/paper' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"> <button type="button" >
    PAPER SUBMISSIONS
  </button></a>
  <a href='/registrations' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"> <button type="button" >
    REGISTRAIONS
  </button></a>
  <a href='/venue' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"><button type="button" >
    VENUE
  </button></a>
  <a href='/committees' class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium"><button type="button" >
    COMMITTEES
  </button></a>
