...
const Paper  = ()=>{
  ...
  <li><p className='text-left mx-auto py-2'>The IEEE ICACIC 2023 organisers regard plagiarism as a serious professional misconduct. All submissions will be screened for plagiarism and when identified, the submission by the same author will be rejected.</p></li>
