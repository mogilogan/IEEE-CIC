...
const Paper  = ()=>{
    ...
    >
      <div className='container py-8 mx-auto'>
        <div className=' bg-gradient-to-br from-blue-800 to-blue-400   py-8 rounded-xl flex flex-col'>
          <div className='flex-1 text-gray-100'>
            <h2 className='h2 mb-10 px-4 pt-2 font font-black text-yellow-500 text-xl' >
  ...
  <li><p className='text-left mx-auto py-5 text-gray-300 font-black'>6.	The similarity content should not exceed 20%. Any model/figure/table /data used should be properly cited and prior permission should have been taken for copyrighted material.</p></li>
