...
const Paper  = ()=>{
  ...
  <li><p className='text-left mx-auto py-2'>The ICACIC 2023 organisers regard plagiarism as a serious professional misconduct. All submissions will be screened for plagiarism and when identified, the submission by the same author will be rejected.</p></li>
  ...
  <li><p className='text-left mx-auto py-2'>Moreover ICACIC 2023 does not encourage withdrawals after the paper is accepted.</p></li>
