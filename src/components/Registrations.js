...
const Registrations  = ()=>{
    ...
    >
      <div className='container rounded-xl bg-gradient-to-tr from-blue-400 to-blue-100 mx-auto '>
        <div className=' pb-12 flex flex-col    '>
            
          <div className='flex-1 '>
          <div className=" pb-[1px]">
            <h2 className='h2 mb-4 px-4 pt-4 font font-black text-yellow-600 text-3xl' >
            REGISTRATION FEE
            </h2>
            </div>
            <h1 className="mx-4 py-4"><b>It is mandatory for at least one author of an accepted paper to register for the paper to appear in the conference proceedings.</b></h1>
            <h1 className="text-center text-lg mx-auto pt-4"><b>AUTHOR PARTICIPANT FEES FOR FOREIGN AUTHORS</b></h1>
            <h1 className="text-center mx-auto pb-4"><b>( US DOLLARS/EQUVALENT )</b></h1>
  ...
  <tr className="text-center text-lg  hover:bg-yellow-500">
    <td className="border-r py-3  border-slate-700">Listeners</td>
    <td className="border-r border-slate-700">$20</td>
    <td className="border-r border-slate-700">$20</td>
    <td className="border-r border-slate-700">$20</td>
    <td className=" border:rounded-xl border-slate-700">$20</td>
  </tr>
</table>
    </div>
    </div>
...
<h1 className="mx-4 "><b>* Early Bird Payments must be made before 23.10.2023</b></h1>
<h1 className="mx-4 "><b> Late payments must be made before 01.11.2023</b></h1>
<h1 className="text-center mx-auto text-lg pt-4"><b>AUTHOR PARTICIPANT FEES FOR INDIAN AUTHORS</b></h1>
...
<table className="border-collapse rounded-xl max-w-[690px] bg-gradient-to-br from-red-500 to-red-300  mx-auto border-slate-700">
  <tr className="text-center text-lg">
    ...
    <th className=" border-l border-b border-slate-700" >ICACIC - Computational Intelligence and Communication</th>
  </tr>
  ...
  <tr className="text-center text-lg hover:bg-teal-500">
    ...
    <td className="border-l border-slate-700">Puducherry Technological University (erstwhile Pondicherry Engineering College campus), Pillaichavadi, Puducherry - 605014</td>
      ...
      <div className="container  text-lg rounded-xl shadow-dark-neumorphism-l mx-auto bg-gradient-to-br from-blue-400 to-blue-100">

<ul class="list-decimal text-justify mx-auto py-10 text-left px-12">
  <li><p className='text-left text-justify pb-1 pt-5 mx-auto'>The conference registration covers conference kit, coffee breaks and lunch.</p></li>
  <li><p className='text-left text-justify py-1 mx-auto'>The registration doesn’t cover accommodation, transportation etc.</p></li>
  <li><p className='text-left text-justify py-1 mx-auto'>All accepted papers will be published in the conference proceedings only if at least one author of an accepted paper registers at the full registration rate. If an author has got more than one accepted papers, each paper has also to be registered .</p></li>
  <li><p className='text-left text-justify mx-auto py-1'><b>It may be ensured that the Remitter’s (Participant/Author) name, Paper-ID and address (Registration Fees) is clearly mentioned by the Remitter in the Funds Transfer Application.</b></p></li>
  <li><p className='text-left text-justify mx-auto py-1'>Indian Nationals or Students , residing in overseas have to pay foreign authors' registration rate only.</p></li>
  <li><p className='text-left  text-justify mx-auto py-1'>Accepted and presented paper will be included in the conference proceedings.</p></li>
  <li><p className='text-left  text-justify mx-auto pt-1  font-black'>Student and Research Scholar Registration:</p><br/>
  <ul className=' pl-5'>
    <li className='text-left pb-1 mx-auto text-justify mr-2'>Students have to submit their scanned copy of the ID card along with the Registration form to avail the deduction. When the students are coming for the presentation, they have to produce the original Student ID card and bonafide certificate from the Head of the Institution/Department.</li>
    </ul>
  </li>
  <li><p className='text-left mx-auto py-5'><b>Please note that Conference Attendee / Listener registration fee doesn’t cover registration kit and proceedings</b></p></li>
  <li><p className='text-left mx-auto py-5'>If you have any questions or clarifications on registration, please email us at: cic@ptuniv.edu.in</p></li>
</ul>
</div>
</div>
      </div>
